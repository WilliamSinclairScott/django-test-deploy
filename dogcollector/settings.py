...
SECRET_KEY = 'django-insecure-#cho1-lfeu5bco0=7j=@dkx0^_h+$g0!f=asw$l=cgw46n^kzo'
...
DATABASES = {
    'default': {
        ...
        # 'USER': 'dog_admin', <-- (optional) postgres user name, if you have to sign into an account to open psql, you will want to add that user name here.
